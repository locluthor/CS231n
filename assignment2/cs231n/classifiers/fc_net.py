...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        H, hid_cache = affine_relu_forward(X, W1, b1)
        ...
        dX, dW1, db1 = affine_relu_backward(dH, hid_cache)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers):  # forward pass except output layer
            ...
            if i == self.num_layers-1:
                hidden_layer, fcache  = affine_forward(*arguments)
                ...
                if self.use_dropout:
                    hidden_layer, dcache = dropout_forward(hidden_layer, self.dropout_param)
